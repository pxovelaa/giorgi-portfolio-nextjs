      ...
      <div className="max-w-[1240px] w-full h-full mx-auto p-2 flex justify-center items-center ">
        <div>
          ...
          <p className="py-4 text-gray-600 max-w-[70%] m-auto ">
            Front-end Developer with 3+ years of experience designing,
            developing, and managing complex sites and internal frameworks.
            Specializes in React.js and responsive design.Currently, I'm focused
